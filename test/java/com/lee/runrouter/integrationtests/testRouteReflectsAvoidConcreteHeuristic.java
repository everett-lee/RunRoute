...
public class testRouteReflectsAvoidConcreteHeuristic {
    ...
    public void setUp() {
        ...
        // avoided paths options
        avoidedPathsInclusive = new ArrayList<>(Arrays.asList("CONCRETE", "ASPHALT"));
    ...
    public void testHeuristicReflectedMorrish() throws PathNotGeneratedException {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            fh.setDislikedSurfaces(avoidedPathsExclusive);
            ...
            fh.setDislikedSurfaces(avoidedPathsInclusive);
